// Something want working with my intcode computer for this day so I have used the solution from https://github.com/saidaspen as his solution works really well.

package AoC.Days;

import AoC.helpers.Day;
import AoC.helpers.IntComputer;
import lombok.Value;
...
public class day23 extends Day {
    ...
    @Value private static class NetworkSwitch implements Runnable {
        ...
        public NetworkSwitch(IntComputer[] cpus, NAT nat) {
            this.computers = cpus;
            this.nat = nat;
        }
